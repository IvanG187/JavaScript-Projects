...
function placeXOrO(squareNumber) {
    ...
    if(!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if(activePlayer === 'X') {
            //if activePlayer is eqal to X the x.png is placed in html
...
function checkWinConditions() {
    ...
    // This condition checks for tie. if none of the aboce conditions register and 9
    ...
    // This function checks if an array incldues 3 strings it is used to check for each win condition.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    y1 = coordY1,
    //This  line indicates where the start of a linesx axis is
    x2 = coordX2,
...
animateLineDrawing();
//This line waits 1 second, then, clears canvas, reseats game, and allows clicking again.
